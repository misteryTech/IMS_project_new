...
<head>
    ...
    <title>Pork Meat Registration</title>
...
?>
    <div class="main-content">
        ...
        <div class="content">
            ...
            <h2>Register Pork Meat</h2>

            <div class="form-group">
                <label for="quantity">Meat Type</label>
                <input type="text" id="meat_type" name="meat_type" value="Pork" readonly>
            </div>

            <div class="form-group">
                <label for="part">Pork Part:</label>
                <select id="part" name="part">
                    ...
                    <option value="whole">Whole Pork</option>
                </select>
            </div>
            <div class="form-group">
            ...
            <button type="submit">Register Pork Meat</button>
            </form>
        </div>
    </div>
