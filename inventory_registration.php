            ...
            <label>Meat Id</label>
                                    <select  id="meat_id" name="meat_id" required>
                                       ...
                                       include("connection.php");
                                              ...
                                              $mysqli_query_supplier =  mysqli_query($connection,"SELECT * FROM meat_db");
                                                          echo "<option>Select Meat</option></option>";
                                                    while ($row = mysqli_fetch_assoc($mysqli_query_supplier)) {

                                                      echo "<option value='" . $row['id'] . "'>Meat Details: " . $row['meat_type'] . ' ' . $row['meat_parts']. ' - Price: ' .$row['meat_price']. "</option>";
                                                              }
                                       ?>
