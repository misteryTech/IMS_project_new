<div class="sidebar" style="background-color: #2f2f2f; color: white; padding: 20px; position: fixed; top: 0; left: 0; width: 220px; height: 100vh;">
    ...
    <ul>
        <li><a href="order_dashboard.php" style="color: white; text-decoration: none; padding: 8px; display: block;">Dashboard</a></li>
        ...
        <li><a href="view-order.php" style="color: white; text-decoration: none; padding: 8px; display: block;">Order</a></li>
